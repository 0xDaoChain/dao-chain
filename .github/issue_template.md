...
## Your environment
- OS and version.
- The version of the dao-chain.    
  (*Confirm the version of your dao-chain client by running the following command: `dao-chain version --grpc-address GRPC_ADDRESS`*)
...
- Provide us with the peer list of each of your validators by running the following command: `dao-chain peers list --grpc-address GRPC_ADDRESS`.
